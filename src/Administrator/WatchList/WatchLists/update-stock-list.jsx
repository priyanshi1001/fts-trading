...
import {
  fetchIBStockList,
  updateStockListAndWatchListApi,
  fetchStockListApi,
  deleteStockListApi,
  updateWatchListApi
} from "../../../api/ApiCall";
...
export default function Stocks() {
  ...
  const [isLoadingAddedStockList, setIsLoadingAddedStockList] = useState(true);
  ...
  useEffect(() => {
    ...
    fetchStockListApi(id).then((response) => {
      ...
      toast.error("Sever not responded.");
      setIsLoadingAddedStockList(false);
    })
  }, [])

  function handleUpdateStockFun(stockObj) {
    let { id } = params;
    if (!watchListName) {
    ...
    updateStockListAndWatchListApi(id, {
      ...
      console.log("updateStockListAndWatchListApi Error:", err.message);
  ...
  function handleUpdateWatchListFun() {
    let { id } = params;
    if (!watchListName) {
      toast.error("Please enter watch list name.", {
        toastId: "watch-list-name-error"
    ...
    updateWatchListApi(id, {
      ...
      console.log("updateWatchListApi Error:", err.message);
      toast.error("Something went wrong. please try again.", {
        toastId: "watch-list-update"
      });
    })
  }
                        ...
                        >
                          <Box component={"div"} className="d-flex align-items-center justify-content-start gap-4">
                            ...
                            <Box component={"div"} className="d-flex flex-wrap justify-content-start align-items-center gap-2">
                              ...
                              />
                              <button
                                className="btn btn-sm rounded-3 btn-purple"
                                onClick={() => handleUpdateWatchListFun()}
                              >
                                Update Watch List
                              </button>
                            </Box>
                                  ...
                                  >
                                    ...
                                    <TableCell className="table_content tableRow1">
                                      <button
                                        ...
                                        onClick={() => handleUpdateStockFun(row)}
                                      >
                                        + Add
                                      </button>
                                    </TableCell>
