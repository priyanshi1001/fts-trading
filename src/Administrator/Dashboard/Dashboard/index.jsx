...
import {getAllContentType ,getContentLanguageById,importContent} from "../../../redux/Actions";
            ...
            <Pagination
             ...
             color="primary"
              ...
              <div className="col-12 mb-4 mt-2" >
                ...
                <Button  size="small"className="btn-cstm  mb-4" style={{ float: "right" ,marginLeft:'5px'}}>
                  Export 
                </Button>
              </div>
